...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
            <h4 class="m-0">Ubah Daftar Mahasiswa</h4>
            </div><!-- /.col -->
            <div class="col-sm-12">
            ...
            <div class="col-md-9">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Ubah Daftar Mahasiswa</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                @foreach ($data as $dt)
                    
                <form role="form" action="{{url('/admin/pengguna/mahasiswa/update')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="text" class="form-control" name="nim" placeholder="NIM" value="{{$dt->nim}}" required>
                                </div>
                                @if($errors->has('nim'))
