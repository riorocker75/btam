...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
            <h4 class="m-0">Tambah Daftar Mahasiswa</h4>
            </div><!-- /.col -->
            <div class="col-sm-12">
            ...
            <div class="col-md-9">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Tambah Daftar Mahasiswa</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{url('/admin/pengguna/mahasiswa/act')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
